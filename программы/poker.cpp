...
class Deck {
    public:
        ...
        void shuffle() {
            ...
            cout << "Тасовка карт и раздача..." << endl << endl;
            sleep(2);
            for (int i = 0; i < 52; i++) {
                x = rand() % 52;
                tempCard = cards[i];
        ...
        void takeBets() {
            ...
            for (int k = bind + 1; k < bind + 7; k++) {
                if (k % 6 == 4 && players[4].round) {
                    if (betOn) {
                        cout << "Ваше действие: (1) FLOP (3) BET/CALL ";
                        cin >> action;
                        ...
                        cout << "Ваше действие: (1) FLOP (2) CHECK (3) BET/CALL ";
                        cin >> action;
                        while (action < 1 || action > 3) {
                            cout << "Неверное число, повторите." << endl;
                            cout << "Ваше действие: (1) FLOP (2) CHECK (3) BET/CALL ";
                    ...
                    if (action == 1)
                        ...
                        if (betOn){
                            ...
                            cout << "Какую ставку хотите сделать: ";
                            cin >> bet;
                            while (bet>players[4].money || bet < 1) { 
                                cout << "Недостаточно денег, введите другую сумму." << endl;
                                cout << "Какую ставку хотите сделать: ";
                                cin >> bet;
                                cout << endl << endl;
                            }
        ...
        void startGame() {
            ...
            while(playersLeft() > 1) {
                ...
                if(players[4].playing == 0) {
                    cout << "У вас закончились деньги, извините." << endl;
                    cout << "Game over." << endl;
                    break;
                }
                ...
                cout << "Подготовка к раунду " << (i+1) << "..." << endl;
                sleep(1);
                deck1.shuffle();
                ...
                if (oneLeft()) {
                    winner = getWinner();
                    cout << players[winner].name << " Победа $" << pot << endl << endl;
                    i++;
                    continue;
                }
                ...
                cout << endl;
                cout << players[roundWinner].name << " Победа $" << pot << " с ";
                if (maxPoints < 30)
                    cout << "HIGH CARD";
...
int main(){
    ...
    cout << "OK " << name << " начнём играть в Text Poker" << endl << endl;
    sleep(2);
